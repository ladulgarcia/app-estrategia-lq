    ...
    return (
      <div>
          ...
          <div>
           ...
           <br /> Conforme avancemos, te darás cuenta que la numeración no sigue una secuencia con base en paradigmas o introyectos aprendidos.</p>
            ...
            <div style={{ background: '#ECECEC', padding: '5px' }}>
              ...
              <Row gutter={30}>
                <Col span={4} offset={4}>
                  <Card title="14. EXTERNO" style={{ width: 230 }}>
                    <br />
                    <br />
                ...
                <Col span={4}>
                  <Card title="15. SOMBRA" style={{ width: 230 }}>
                    <br />
                ...
                <Col span={4}>
                  <Card title="16. PATRÓN" style={{ width: 230 }}>
                ...
                <Col span={4}>
                  <Card title="17. CREENCIA" style={{ width: 230 }}>
                    <br />
        ...
        <br />Lo importante de estos objetivos es que tienen que representar algo por lo que para ti vale la pena vivir)</i></p>
              <Row gutter={30}>
                <Col span={4} offset={6}>
                  <Card title="18. OBJETIVO 1" style={{ width: 230, height: 150 }}>
                    <p>
                ...
                <Col span={4}>
                  <Card title="19. OBJETIVO 2" style={{ width: 230, height: 150 }}>
                    <p>
                ...
                <Col span={4}>
                  <Card title="20. OBJETIVO 3" style={{ width: 230, height: 150 }}>
                    <p>
            ...
            <div style={{ background: '#ECECEC', padding: '5px' }}>
              ...
              <Row gutter={30}>
                <Col span={5} offset={7}>
                  <Card title="21. PERSONAL" style={{ width: 280 }}>
              ...
              <i>(Ej. ¿Para qué?: Para crear un patrimonio / ¿Para qué?: Para tener más tiempo para mi / ¿Para qué?: Para sentirme más pleno. )</i></p>
                ...
                <Col span={4}>
                  <Card title="21b. COLECTIVO" style={{ width: 280 }}>
